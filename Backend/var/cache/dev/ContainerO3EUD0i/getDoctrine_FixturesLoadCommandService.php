...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'CovoiturageFixtures.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'PreferenceFixtures.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'ReservationFixtures.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'TrajetFixtures.php';
        ...
        $a->addFixtures([['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\AvisFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\CovoiturageFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\PreferenceFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\ReservationFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\TrajetFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\UserFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\VoitureFixtures(), 'groups' => []]]);
